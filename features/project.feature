...
Scenario: 3- Visualizacion correcta de campos requeridos al crear un proyecto - create_project
...
Scenario: 4- Creacion de proyecto exitosa - create_project
...
Scenario: 5- Creacion de proyecto no exitosa - create_project
    Given el usuario del módulo del proyecto quiere dar de alta un proyecto
    When agrega un proyecto y no completa todos los campos requeridos
    Then no puede guardar el proyecto

Scenario: 6- Visualización correcta del detalle de un proyecto - get_by_id
...
********************
Scenario: 7- Edición exitosa del nombre de un proyecto - edit_project
...
Scenario: 8- Edición exitosa de la fecha de inicio del proyecto - edit_project
...
Scenario: 9- Edición exitosa de la fecha de cierre del proyecto - edit_project
...
Scenario: 10- Edición exitosa del cliente de un proyecto - edit_project
...
Scenario: 11- Eliminación exitosa de un proyecto - delete_project_by_id
...
Scenario: 12- Eliminación no exitosa de un proyecto - delete_project_by_id
    Given el usuario del módulo del proyecto quiere eliminar un proyecto particular.
